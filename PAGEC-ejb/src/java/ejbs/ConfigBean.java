...
public class ConfigBean {
    ...
    public void populateBD() {
        ...
        try {
            ...
            caregiverBean.create("c1", "c1", "c1", "c1@11111.com");
            caregiverBean.create("c2", "c2", "c2", "c2@11111.com");
            caregiverBean.create("c3", "c3", "c3", "c3@11111.com");
            caregiverBean.create("c4", "c4", "c4", "c4@11111.com");
            needBean.create(1, "Gaguez");
            needBean.create(2, "Diabetes");
            needBean.create(3, "Lesão");
            needBean.create(4, "Dor de cabeca");
            needBean.create(5, "Pouca visão");
            trainingMaterialBean.create(1, "Como combater a gaguez", TRMAT.VIDEO, "http://gaguez.pt/");
            trainingMaterialBean.create(2, "Como tomar insulina", TRMAT.QUESTIONARIO, "http://insulina.pt/");
